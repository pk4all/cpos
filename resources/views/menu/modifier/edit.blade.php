                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row  col-sm-6">
                            ...
                            <div class="col-9">
                            {!! Form::select("dependent_modifier_group",$dependentModifierGroups, array_column($modifier_data->dependent_modifier_group,'_id'), array('class'=>'form-control','placeholder'=>'Select Dependent Modifier Group')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row  col-sm-6">
                            ...
                            <div class="col-9">
                            {!! Form::select("dependent_modifier",$dependentModifiers, array_column($modifier_data->dependent_modifier,'_id'), array('class'=>'form-control','placeholder'=>'Select Dependent Modifier')) !!}
                            </div>
                        </div>
