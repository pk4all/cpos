...
class CustomerController extends Controller {
    ...
    public function getCustomer(Request $request) {
        ...
        if($customer){
           ...
           return response()->json(["response" => 200, 'status' => 'success', "customer" =>$customer,'store'=>$store]);
        }else{
    ...
    public static function saveCustomer(Request $request){
        ...
        if ($customer->save()) {
            ...
            return response()->json(["response" => 200, 'status' => 'success', "msg" => 'Customer has been saved', "customer" =>$customer,'store'=>$store->first()]);
        } else {
