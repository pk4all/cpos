...
class Helper {
    ...
    public static $menutab=[['name'=>'Items','link'=>'item'],['name'=>'Categories','link'=>'category'],['name'=>'Modifier Choices','link'=>'modifier-choice'],['name'=>'Modifiers','link'=>'modifier'],['name'=>'Modifier Groups','link'=>'modifier-group']];
    ...
    public static $yesNoOptions = ['Yes' => 'Yes', 'No' => 'No'];
