...
class Helper {
    ...
    public static $stafftab=[['name'=>'Users','link'=>'users'],['name'=>'Roles','link'=>'user-roles']];
     public static $menutab=[['name'=>'Menu','link'=>'menu'],['name'=>'Categories','link'=>'category'],['name'=>'Modifier Choices','link'=>'modifier_choice'],['name'=>'Modifiers','link'=>'modifier'],['name'=>'Modifier Groups','link'=>'modifier_group']];
