...
class Category extends Eloquent {
    ...
    {
        return $this->hasMany('App\Models\Menu\Category', 'parent_id');
    }
    ...
    public static function getCategoryListWithChild($id=null,$fields=[]){
        //$arrList=[];
        $categList=self::whereNull('parent_id')->where('status', 'enable')->with('children')->get()->toArray();
        return $categList;
    }
